    ...
    <div class="justify-content-center">
        ...
        <div class="card" style="padding: 16px;">
            <div class="card-body">
                ...
                <a class="btn btn-primary btn-menu btn-icon-text btn-sm mb-3" href="<?php echo e(route('roles.create')); ?>"><i class="mdi mdi-plus btn-icon-prepend"></i><?php echo e(trans('message.Add_role')); ?></a>
                <?php endif; ?>
                ...
                <table class="table table-striped">
                    <thead class="thead-dark">
                        <tr>
                            <th>#</th>
                            <th><?php echo e(trans('message.Role_name')); ?></th>
                            <th width="280px"><?php echo e(trans('message.Role_action')); ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php $i = 1; ?>
                        ...
                        <tr>
                            <td><?php echo e($i++); ?></td>
                            <td><?php echo e($role->{'name_' . app()->getLocale()} ?? $role->name); ?></td>
                            <td>
