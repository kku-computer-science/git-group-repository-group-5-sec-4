...
<div class="container">
    ...
    <div class="card" style="padding: 16px;">
        <div class="card-body">
            <h4 class="card-title"><?php echo e(trans('message.Create_research_group')); ?></h4>
            <p class="card-description"><?php echo e(trans('message.Input_research_group_detail')); ?></p>
            <form action="<?php echo e(route('researchGroups.store')); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input name="group_name_en" value="<?php echo e(old('group_name_cn')); ?>" class="form-control"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <textarea name="group_desc_cn" value="<?php echo e(old('group_desc_cn')); ?>" class="form-control"
                            style="height:90px"></textarea>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <textarea name="group_detail_th" value="<?php echo e(old('group_detail_th')); ?>" class="form-control"
                            style="height:90px"></textarea>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <textarea name="group_detail_cn" value="<?php echo e(old('group_detail_cn')); ?>" class="form-control"
                            style="height:90px"></textarea>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <button type="submit" class="btn btn-primary upload mt-5"><?php echo e(trans('message.Submit_button')); ?></button>
                <a class="btn btn-light mt-5" href="<?php echo e(route('researchGroups.index')); ?>"> <?php echo e(trans('message.Back_button')); ?></a>
                </form>
        </div>
    </div>
</div>
