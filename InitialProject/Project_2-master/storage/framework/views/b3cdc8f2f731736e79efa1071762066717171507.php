    ...
    <div class="form">
        ...
        <div class="form-panel one">
            <div class="form-header">
                <h1><?php echo e(trans('message.Account_Login')); ?></h1>
            </div>
                ...
                <form method="POST" class="validate-form" autocomplete="off" action="<?php echo e(route('login')); ?>">
                    ...
                    <?php if($errors->any()): ?>
                        <div class=" alert alert-danger alert-block ">
                            <button type=" button" class="close" data-dismiss="alert"></button>
                            <!--<strong><a><?php echo e($errors->first()); ?></a></strong> -->
                            <strong><a><?php echo e(trans('message.Login_failed')); ?></a></strong>
                        </div>
                    <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>" name="username"
                            value="<?php echo e(old('username')); ?>" data-validate="<?php echo e(trans('message.required.username')); ?>"
                            autofocus>
...
$message = $__bag->first($__errorArgs[0]); ?>
                            <span class="invalid-feedback" role="alert">
                                <strong><?php echo e(trans('message.required.username')); ?></strong>
                            </span>
                        <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group validate-input" data-validate="<?php echo e(trans('message.required.password')); ?>">
...
$message = $__bag->first($__errorArgs[0]); ?>
                            <span class="invalid-feedback" role="alert">
                                <strong><?php echo e(trans('message.required.password')); ?></strong>
                            </span>
                        <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        <label class="form-remember">
                            <input id="ckb1" name="remember"
                                type="checkbox" /><?php echo e(trans('message.Remember_me')); ?>

                        </label>
                    </div>
                    <div class="form-group">
                        <button type="submit"><?php echo e(trans('message.Login_button')); ?></button>
                    </div>
                    <div class="form-remember pb-3">
                        <p style="color: red; text-align: right;"> <?php echo e(trans('message.Forgot_password')); ?></p>
                    </div>
                    <ul>
                        <li><?php echo e(trans('message.Username_kkumail')); ?></li>
                        <li><?php echo e(trans('message.Student_first_time_login')); ?></li>
                    </ul>
                </form>
            </div>
        </div>
