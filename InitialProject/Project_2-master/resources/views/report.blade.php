...
<div class="container card-cart d-sm-flex  justify-content-center mt-5">
    <div class="card">
        <div class="card-body">
         <h5 class="card-title" style="padding: 16px;">{{ __('message.article_stats') }}</h5>
                <div class="row">
...
<div class="container card-cart d-sm-flex  justify-content-center mt-5">
    <div class="card">
        <div class="card-body">
            <h5 class="card-title" style="padding: 16px;">{{ __('message.citation_stats') }}</h5>
                <div class="row">
                    <div class="col-md-6 p-5">
                        <div style="width:520px;height:250px">
...
year.unshift("source");
=======
let locale = "{{ app()->getLocale() }}"; // ดึงค่าภาษาจาก Laravel
