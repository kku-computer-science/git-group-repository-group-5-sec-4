                ...
                <form method="POST" class="validate-form" autocomplete="off" action="{{ route('login') }}">
                    ...
                    @if ($errors->any())
                        <div class=" alert alert-danger alert-block ">
                            <button type=" button" class="close" data-dismiss="alert"></button>
                            <!--<strong><a>{{ $errors->first() }}</a></strong> -->
                            <strong><a>{{ trans('message.Login_failed') }}</a></strong>
                        </div>
                    @endif
                    ...
                    <div class="form-group validate-input">
                        ...
                        <input id="username" type="username"
                            ...
                            value="{{ old('username') }}" data-validate="{{ trans('message.required.username') }}"
                            autofocus>
                        @error('username')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ trans('message.required.username') }}</strong>
                            </span>
                        @enderror
                    </div>
                    <div class="form-group validate-input" data-validate="{{ trans('message.required.password') }}">
                        ...
                        @error('password')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ trans('message.required.password') }}</strong>
                            </span>
                        @enderror
                    </div>
                    <div class="form-group">
                        <label class="form-remember">
                            <input id="ckb1" name="remember"
                                type="checkbox" />{{ trans('message.Remember_me') }}
                        </label>
                    </div>
                    <div class="form-group">
                        <button type="submit">{{ trans('message.Login_button') }}</button>
                    </div>
                    <div class="form-remember pb-3">
                        <p style="color: red; text-align: right;"> {{ trans('message.Forgot_password') }}</p>
                    </div>
                    <ul>
                        <li>{{ trans('message.Username_kkumail') }}</li>
                        <li>{{ trans('message.Student_first_time_login') }}</li>
                    </ul>
                </form>
            </div>
        </div>
