...
if ('D:\soften\sprint1st\Project_2-master\xampp\php\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('D:\soften\sprint1st\Project_2-master\xampp\php\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
